...
@Composable
fun AgentListScreen(
    state: AgentListState, onNavBack: () -> Unit, onNavToAgentDetails: (String) -> Unit
) {
    ...
    Column(
        ...
        TopAppBar(title = { Text(text = "Agents") }, navigationIcon = {
        ...
        LazyVerticalGrid(
            ...
            items(items = state.agentGears, itemContent = {
