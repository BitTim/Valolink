...
class ContractApiRepository @Inject constructor(
    ...
    ): Flow<dev.bittim.valolink.feature.main.domain.model.game.contract.Contract?> {
    ...
    override suspend fun getActiveContracts(providedVersion: String?): Flow<List<dev.bittim.valolink.feature.main.domain.model.game.contract.Contract>> {
        val version = providedVersion ?: versionRepository.getApiVersion()?.version ?: ""
    ...
    override suspend fun getAgentGears(providedVersion: String?): Flow<List<dev.bittim.valolink.feature.main.domain.model.game.contract.Contract>> {
        val version = providedVersion ?: versionRepository.getApiVersion()?.version ?: ""
    ...
    override suspend fun getInactiveContracts(
        contentType: String,
        providedVersion: String?,
    ): Flow<List<dev.bittim.valolink.feature.main.domain.model.game.contract.Contract>> {
        val version = providedVersion ?: versionRepository.getApiVersion()?.version ?: ""
        val currentIsoTime = Instant.now()
            .toString()
