...
package dev.bittim.valolink.feature.main.ui.screens.content.contracts.components
...
import dev.bittim.valolink.feature.main.ui.components.conditional
...
fun AgentCarouselCard(
    ...
    AgentCardBase(modifier = modifier
        .onSizeChanged {
...
fun AgentCarouselCardPreview() {
    ValolinkTheme {
        AgentCarouselCard(Modifier.width(300.dp),
...
fun SmallestAgentCarouselCardPreview() {
    ...
    ValolinkTheme {
        AgentCarouselCard(Modifier.width(width),
                          backgroundGradientColors = listOf(
                              "f17cadff",
                              "062261ff",
                              "c347c7ff",
...
fun CompressedAgentCarouselCardPreview() {
    ValolinkTheme {
        AgentCarouselCard(Modifier.width(100.dp),
                          backgroundGradientColors = listOf(
                              "f17cadff",
                              "062261ff",
                              "c347c7ff",
