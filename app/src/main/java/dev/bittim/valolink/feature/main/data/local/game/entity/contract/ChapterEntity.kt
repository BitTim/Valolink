package dev.bittim.valolink.feature.main.data.local.game.entity.contract

import androidx.room.Entity
import androidx.room.ForeignKey
import androidx.room.Index
import androidx.room.PrimaryKey
import dev.bittim.valolink.feature.main.data.local.game.entity.GameEntity
...
data class ChapterEntity(
    ...
    ): dev.bittim.valolink.feature.main.domain.model.game.contract.Chapter {
        return dev.bittim.valolink.feature.main.domain.model.game.contract.Chapter(
            levels,
            freeRewards,
            isEpilogue
        )
