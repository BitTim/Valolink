 ...
 * License:    GPLv3
 *
 * File:       RootContainerScreen.kt
 * Module:     Valolink.shared.commonMain
 * Author:     Tim Anhalt (BitTim)
 * Modified:   24.05.26, 12:57
 */

package dev.bittim.valolink.core.ui.screen
...
@Composable
fun RootContainerScreen(
    showNavBar: Boolean = false,
    content: @Composable (PaddingValues) -> Unit,
    navigateTopLevel: (AppDestination) -> Unit
) {
                ...
                NavigationBar {
                    NavBarDestination.entries.forEachIndexed { index, destination ->
                        NavigationBarItem(
                            ...
                            onClick = {
                                navigateTopLevel(destination.destination)
