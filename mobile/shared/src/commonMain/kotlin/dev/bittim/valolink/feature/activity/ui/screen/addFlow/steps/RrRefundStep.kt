 ...
 */
/**
 * Displays the RR refund step and provides a Finish action for completing it.
 *
 * @param visibleRrDelta The current RR refund value to display.
 * @param rrDeltaError The validation error associated with the RR refund value.
 * @param enableContinueButton Whether the Finish button is enabled.
 * @param onAction Receives actions generated by the refund section and Finish button.
 */
@Composable
fun RrRefundStep(
